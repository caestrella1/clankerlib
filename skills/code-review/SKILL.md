...
6. **Check maintainability.** Look for duplicated logic, unclear names, functions doing too much, and dead code.
...
8. **Report** using the format below, most severe first.
